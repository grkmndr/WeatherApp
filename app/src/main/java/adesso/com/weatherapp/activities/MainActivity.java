...
public class MainActivity extends
    ...
    private LoaderCallbacks<WeatherModel> currentLocationWeatherLoaderListener
        ...
        public Loader<WeatherModel> onCreateLoader(int id, Bundle args) {
            return new AsyncTaskLoader<WeatherModel>(MainActivity.this) {
                ...
                /* This String array will hold and help cache our weather data */
                WeatherModel mCurrentLocationWeatherData = null;
                ...
                public WeatherModel loadInBackground() {
                    ...
                    URL currentLocationWeatherRequestUrl = NetworkUtils.buildCurrentLocationUrl(lat.toString(), lon.toString(), "forecast");

                    try {
                        String jsonWeatherResponse = NetworkUtils
                                .getResponseFromHttpUrl(currentLocationWeatherRequestUrl);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            invalidateData();
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, forecastLoaderListener);
            return true;
        }
    ...
    @Override
    public void onClick(WeatherModel weatherForDay) {
    ...
    @Override
    public Loader<WeatherModel[]> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<WeatherModel[]>(this) {
            ...
            public WeatherModel[] loadInBackground() {
                ...
                URL weatherRequestUrl = NetworkUtils.buildUrl(locationQuery, "forecast");
                URL currentLocationWeatherRequestUrl = NetworkUtils.buildUrl(lat.toString(), lon.toString());
